...
In the meantime, we set $ \gamma_+ = \sum_q(\gamma_{4,q}+\gamma_{3,q}) $, and then 
\begin{align}
...
&\quad \!+\! \expect{\! \sum_{F,q,i} \!\! \gamma_{F,q} \op{F,0}{F,0}^{(i)} \left(\sum_{i'}^{N_A}\frac{\hat{\sigma}_z^{(i')}}{2} \right)^2 \op{F,0}{F,0}^{(i)} }\\
...
&\quad \!+\! \frac{1}{8}\sum_{F,q} \expect{\sum_{i}^{N_A} \gamma_{F,q}\left[\hat{I}^{(i)}\!+\!(\!-1\!)^F\hat{\sigma}_z^{(i)} \right]\!\!\cdot\!\! \left[\sum_{i'}^{N_A}\!\hat{I}^{(i')} \!+\! \sum_{i'\neq j'}^{N_A}\!\! \hat{\sigma}_z^{(i')} \hat{\sigma}_z^{(j')}  \right]\!\!\cdot\!\! \left[\hat{I}^{(i)}\!+\!(\!-1\!)^F\hat{\sigma}_z^{(i)}\right]}\\
&\approx -\gamma_s^+\expect{\hat{J}_z^2} \!-\! \frac{\gamma_s^-}{8}\expect{\sum_{i}^{N_A}\left\{\hat{\sigma}_z^{(i)}, \sum_{i'}^{N_A}\left(\hat{\sigma}_z^{(i')} \right)^2 + \sum_{i'\neq j'}^{N_A} \hat{\sigma}_z^{(i')} \hat{\sigma}_z^{(j')}  \right\} } \nonumber\\
&\quad \!+\! \gamma_+ N_A^2 \!+\! 2\gamma_+N_A \expect{\hat{J}_z}^2 \!+\! \gamma_- N_A\expect{\hat{J}_z} \!+\! \gamma_-\!\left[2\expect{\hat{J}_z}^3\!\!+\!(N_A\!-\! 1)\expect{\hat{J}_z} \right] \\
...
&\quad \!+\! \gamma_+ N_A^2 \!+\! 2\gamma_+N_A \expect{\hat{J}_z}^2 \!+\!  \gamma_-\left[2\expect{\hat{J}_z}^3+(2N_A-1)\expect{\hat{J}_z} \right]\\
...
&\quad \!+\! \gamma_+ N_A^2 \!+\! 2\gamma_- \expect{\hat{J}_z}^3 \!+\! 2\gamma_+ N_A \expect{\hat{J}_z}^2 \!+\!  \gamma_-(2N_A-1)\expect{\hat{J}_z}\\
&= -\gamma_s^+\expect{\hat{J}_z^2} \!-\! \frac{\gamma_s^-}{2}\expect{\hat{J}_z}\!-\! \frac{\gamma_s^-}{2}(N_A-1)\expect{\hat{J}_z} \nonumber\\
&\quad \!+\! \gamma_+ N_A^2 \!+\! 2\gamma_- \expect{\hat{J}_z}^3 \!+\! 2\gamma_+ N_A \expect{\hat{J}_z}^2 \!+\!  \gamma_-(2N_A-1)\expect{\hat{J}_z}\\
&= -\gamma_s^+\expect{\hat{J}_z^2} \!+\! \left[ \gamma_-(2N_A\!-\! 1) -\frac{\gamma_s^-}{2}N_A\right] \expect{\hat{J}_z} \!+\! \gamma_+ N_A  \!+\! 2\gamma_- \expect{\hat{J}_z}^3 \!+\! 2\gamma_+ N_A \expect{\hat{J}_z}^2.\label{eq:expJz2eq}
...
\centering
\subfloat[]{\label{fig:xi_magic33_yq}\includegraphics[scale=0.55]{./Figs/xi_magic33_yq}}
\end{minipage}
\begin{minipage}{.45\linewidth}
\centering
\subfloat[]{\label{fig:xi_magic44_yq}\includegraphics[scale=0.55]{./Figs/xi_magic44_yq}}
\end{minipage}
\par\medskip
\begin{minipage}{.45\linewidth}
\centering
\subfloat[]{\label{fig:xi_magic33_zq}\includegraphics[scale=0.55]{./Figs/xi_magic33_zq}}
\end{minipage}
\begin{minipage}{.45\linewidth}
\centering
\subfloat[]{\label{fig:xi_magic44_zq}\includegraphics[scale=0.55]{./Figs/xi_magic44_zq}}
\end{minipage}
%\centering\makebox[\textwidth]{
