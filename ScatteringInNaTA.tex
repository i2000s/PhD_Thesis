...
%&= \frac{i}{r\!_\perp}\left[\frac{1}{2}\left[ id_{r\!_\perp}\beta H_m^{(1)}\left( {pr\!_\perp^{\prime} }\right) J_m\left( pr\!_\perp \right)-d_z H_m^{(1)}\left( {pr\!_\perp^{\prime} }\right) \frac{\mathrm{d}}{\mathrm{d}r\!_\perp}J_{m}\left( pr\!_\perp \right) \right]\right.\nonumber\\
%&\qquad + \frac{r\!_\perp}{2}\left[ id_{r\!_\perp}\beta H_m^{(1)}\left( {pr\!_\perp^{\prime} }\right) \frac{\mathrm{d}}{\mathrm{d}r\!_\perp}J_m\left( pr\!_\perp \right)-d_z H_m^{(1)}\left( {pr\!_\perp^{\prime} }\right) \frac{\mathrm{d}^2}{\mathrm{d}r^2\!\!_\perp}J_{m}\left( pr\!_\perp \right) \right] \nonumber\\
%&\qquad -\left. \frac{im}{2}(\frac{id_z m}{r\!_\perp}- id_\phi \beta)H_m^{(1)}\left( {pr\!_\perp^{\prime} }\right) J_m\left( pr\!_\perp \right)  \right]\\
...
%&= -\frac{i}{2}\left[ (-\frac{d_z \beta m }{r\!_\perp}+\beta^2d_\phi) H_m^{(1)}\left( {pr\!_\perp^{\prime} }\right)J_m\left( pr_\perp \right)\right.\nonumber\\
%&\quad -\frac{1}{r\!_\perp}(d_\phi-id_{r\!_\perp}m) H_m^{(1)}\left( {pr\!_\perp^{\prime} }\right) \frac{\mathrm{d}}{\mathrm{d}r\!_\perp}J_m\left( pr_\perp \right) \nonumber\\
%&\quad -\left.  d_\phi H_m^{(1)}(pr'\!\!_\perp) \frac{\mathrm{d}^2}{\mathrm{d}r^2\!\!_\perp}J_m(pr\!_\perp) \right]\\
...
%&= -\frac{m}{2r^2\!\!_\perp}\left[(d_\phi\!-\! id_{r\!_\perp}m) H_m^{(1)}(pr'\!\!_\perp)J_m(pr\!_\perp) \!+\! d_\phi r\!_\perp H_m^{(1)}(pr'\!_\perp) \frac{\mathrm{d}}{\mathrm{d}r\!_\perp}J_m(pr\!_\perp)\right]\nonumber\\
%&\quad +\! \frac{\beta}{2}\left[ id_{r\!_\perp}\beta H_m^{(1)}\left( {pr\!_\perp^{\prime} }\right) J_{m}\left( pr\!_\perp \right) \!-\! d_z H_m^{(1)}\left( {pr\!_\perp^{\prime} }\right) \frac{\mathrm{d}}{\mathrm{d}r\!_\perp}J_{m}\left( pr\!_\perp \right) \right]\\
