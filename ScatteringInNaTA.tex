...
\end{align}
By substituting Equ.~\eqref{eq:sigmageomega} into \erf{Eq::aguidedomega} and defining asymptotic modes,  $\hat{a}^{\inp}(\omega) = \lim_{t_0\rightarrow -\infty} \hat{a}(t_0) e^{i\omega t_0}$, $\hat{a}^{\out}(\omega) = \lim_{t\rightarrow +\infty} \hat{a}(t) e^{i\omega t}$ \cite{fan_input-output_2010}, we obtain the input-output relationship for the guided modes,
...
\end{align}
The atomic polarizability tensor $\tensor{\alpha}$\index{polarizability!tensor polarizability} is composed of a dyad of vector dipole operators,    
\begin{align}
...
rewrite the result above in terms of dyadic Green functions\index{dyadic Green function!guided mode dyadic Green functions} and tensor polarizabilities\index{polarizability!tensor polarizability} as
\begin{align}
...
In our case, we are only interested in the \textit{clock-state} subspace of the atoms, which fixes $ m=0 $ for the ground states and $ m'=q $ for the excited states to have non-zero contributions from the corresponding quantum transitions. We also want to restrict our attention to the magic frequency case, in which the coherent transition rates for the two ground sublevels, $ \ket{\uparrow}=\ket{F=4,m_F=0} $ and $ \ket{\downarrow}=\ket{F=3,m_F=0} $, are equal and do not contribute to the dynamics of the system ($ [\hat{H}_{\rm coh}\hat{\rho}-\hat{\rho}\hat{H}_{\rm coh}]=0 $ using $ y $-axis as the quantization axis). The loss part of the effective Hamiltonian at a magic frequency can be given by
\begin{align}
\hat{H}_{\rm loss} &= i\hbar  \left( \Im\left[ \gamma_{\uparrow}\right] \op{\uparrow}{\uparrow} + \Im\left[ \gamma_{\downarrow}\right] \op{\downarrow}{\downarrow} \right)\\
&=  i\hbar  \left[ \frac{\Im\left[ \gamma_{\uparrow}\right]}{2} \left(\hat{I}+\hat{\sigma}_z \right) + \frac{\Im\left[ \gamma_{\downarrow}\right]}{2} \left(\hat{I}-\hat{\sigma}_z \right) \right]\\
&= \frac{i\hbar}{2} \left( \Im \left[\gamma_{\uparrow}+\gamma_{\downarrow}\right] \hat{I} + \Im\left[\gamma_{\uparrow}-\gamma_{\downarrow}\right]\hat{\sigma}_z  \right)\\
&= -\frac{i\hbar}{2}\left(\gamma_s^+\hat{I} + \gamma_s^-\hat{\sigma}_z \right)
\end{align}
where 
\begin{align}
 \gamma_s^+ &= -\Im\left[\gamma_{\uparrow}+\gamma_{\downarrow} \right]\\
\gamma_s^- &= -\Im\left[\gamma_{\uparrow}-\gamma_{\downarrow} \right]\\
\!\!\!\!\!\!\!\! \Im\left[\gamma_{\uparrow}\right] &= \!-\! \sum_{F'} \! \frac{|\bra{J'}|d|\ket{J}|^2\Gamma/2}{\hbar^2(\Delta_{4,F'}^2+\Gamma^2/4)}|\mathcal{E}^{(+)}(\br')|^2\!\! \sum_{q}\! |o^{J'F'}_{J4}\! C^{4 0;1q}_{F' q} |^2 |\mathbf{e}_q\!\cdot\! \mathbf{e}_L^*|^2\\
&= \!-\! \sum_{F'} \! \frac{\Gamma\Omega^2/8}{\Delta_{4,F'}^2+\Gamma^2/4}\!\! \sum_{q}\! |o^{J'F'}_{J4}\! C^{4 0;1q}_{F' q} |^2 |\mathbf{e}_q\!\cdot\! \mathbf{e}_L^*|^2\\
&= -\frac{\dot{N}_L}{2}\frac{\pi \omega_0}{\hbar v_g} \!\!\sum_{F'\! , q}\! \frac{\Gamma |\bra{J'}|d|\ket{J}|^2}{\Delta_{4,F'}^2+\Gamma^2/4} |o^{J'F'}_{J4}\! C^{4 0;1q}_{F' q}|^2  %\nonumber\\
%&\quad\quad\quad\quad\quad\quad\quad\quad\quad   
|\mathbf{e}_q \!\cdot\! 
\left( \mathbf{u}_{H}^*(\br^\prime\!\!_\perp) \!+\! 
\mathbf{u}_{V}^*(\br^\prime\!\!_\perp)\right) |^2\\
\Im\left[\gamma_{\downarrow}\right] &=\!-\! \sum_{F'} \! \frac{|\bra{J'}|d|\ket{J}|^2\Gamma/2}{\hbar^2(\Delta_{3,F'}^2+\Gamma^2/4)}|\mathcal{E}^{(+)}(\br')|^2\!\! \sum_{q}\! |o^{J'F'}_{J3}\! C^{3 0;1q}_{F' q} |^2 |\mathbf{e}_q\!\cdot\! \mathbf{e}_L^*|^2\\
&= \!-\! \sum_{F'} \! \frac{\Gamma\Omega^2/8}{\Delta_{3,F'}^2+\Gamma^2/4}\!\! \sum_{q}\! |o^{J'F'}_{J3}\! C^{3 0;1q}_{F' q} |^2 |\mathbf{e}_q\!\cdot\! \mathbf{e}_L^*|^2\\
&= -\frac{\dot{N}_L}{2}\frac{\pi \omega_0}{\hbar v_g} \!\!\sum_{F'\! , q}\! \frac{\Gamma |\bra{J'}|d|\ket{J}|^2}{\Delta_{3,F'}^2+\Gamma^2/4} |o^{J'F'}_{J3}\! C^{3 0;1q}_{F' q}|^2  %\nonumber\\
%&\quad\quad\quad\quad\quad\quad\quad\quad\quad   
|\mathbf{e}_q \!\cdot\! 
\left( \mathbf{u}_{H}^*(\br^\prime\!\!_\perp) \!+\! 
\mathbf{u}_{V}^*(\br^\prime\!\!_\perp)\right) |^2.
...
In the \textit{clock-state} case, we define $ \ket{\uparrow} = \ket{F=4,m_F=0} $, $ \ket{\downarrow}=\ket{F_3,m_F=0} $ for an arbitrary $ i $-th atom. 
...
&\quad + \frac{1}{2}\left[ \frac{1}{2}(\gamma_{44} -\gamma_33+\gamma_{43}-\gamma_{34})- \gamma_s^-\right] \expect{\hat{N}_A}.\label{eq:expJzeq}
\end{align}
...
&\quad \!+\! \frac{1}{4}\sum_{i\neq j}^{N_A} \left[ (\gamma_{44}+\gamma_{33}-\gamma_{43}-\gamma_{34})  -2\gamma_s^+\right]\expect{\hat{\sigma}_z^{(i)} \hat{\sigma}_z^{(j)}} \nonumber\\
&\quad \!+\! \frac{1}{4}\sum_{i\neq j}^{N_A} \left[ (\gamma_{44}-\gamma_{33}+\gamma_{43}-\gamma_{34})  -2\gamma_s^-\right]\expect{\mathrm{Sym}(\hat{I}^{(i)}\hat{\sigma}_z^{(j)} ) }\\
&= \frac{1}{4}\left[ \frac{1}{2} (\gamma_{44}+\gamma_{33}+\gamma_{43}+\gamma_{34})  -\gamma_s^+\right]\expect{\hat{N}_A} \nonumber\\
&\quad \!+\! \frac{1}{4} \left[  (\gamma_{44}-\gamma_{33}-\gamma_{43}+\gamma_{34})  -2\gamma_s^-\right] \expect{\hat{J}_z} \nonumber\\
...
&\quad +\left[ (\gamma_{44}-\gamma_{33}-\gamma_{43}+\gamma_{34})  -2\gamma_s^-\right]\expect{\hat{\sigma}_z^{(1)} \hat{\sigma}_z^{(2)}} .
\end{align}
...
For an simple estimation of the solution of the equation above, we can assume $ \expect{\hat{J}_z}\approx 0 $ and $ \expect{\hat{N}_A}=N_A $. 
The general form of the equation above can be given by
\begin{align}
	\frac{d x}{d t} = -A x^2 - B x + C
\end{align}
for $ x=\Delta J_z^2 $, $ A = \kappa $, $ B=(\gamma_{44}+\gamma_{33}-\gamma_{43}-\gamma_{34} ) -2\gamma_s^+ $ and $ C=-\frac{1}{4}\left[\frac{1}{2}(\gamma_{44}+\gamma_{33}-3\gamma_{43}-3\gamma_{34} ) -\gamma_s^+\right]  $. 
...
The variance, $\Delta J_z^2 $, can be characterized by the normalized rate $ \gamma_{\rm norm}= \sqrt{B^2 + 4 AC}$. 
...
\centering
\subfloat[]{\label{fig:clockdynamics_m33_yq_rp1d5_exact}\includegraphics[scale=0.45]{./Figs/clockdynamics_m33_yq_rp1d5_exact}}
\end{minipage}
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{fig:clockdynamics_m33_yq_rp1d5_approx}\includegraphics[scale=0.45]{./Figs/clockdynamics_m33_yq_rp1d5_approx}}
\end{minipage}
\par\medskip
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{fig:clockdynamics_m44_yq_rp1d5_exact}\includegraphics[scale=0.45]{./Figs/clockdynamics_m44_yq_rp1d5_exact}}
\end{minipage}
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{fig:clockdynamics_m44_yq_rp1d5_approx}\includegraphics[scale=0.45]{./Figs/clockdynamics_m44_yq_rp1d5_approx}}
\end{minipage}
...
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{fig:xi_magic33_yq}\includegraphics[scale=0.45]{./Figs/xi_magic33_yq}}
\end{minipage}
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{fig:xi_magic44_yq}\includegraphics[scale=0.45]{./Figs/xi_magic44_yq}}
\end{minipage}
\par\medskip
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{fig:xi_magic33_xq}\includegraphics[scale=0.45]{./Figs/xi_magic33_xq}}
\end{minipage}
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{fig:xi_magic44_xq}\includegraphics[scale=0.45]{./Figs/xi_magic44_xq}}
\end{minipage}
%\centering\makebox[\textwidth]{
