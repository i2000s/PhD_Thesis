...
\end{align}
This approximation is known as \textit{Holstein-Primakoff approximation}\index{approximation!Holstein-Primakoff approximation}. Using this approximation, the uncertainty area on the Bloch sphere can be mapped to a flat phase plane. 
