...
\end{align}
\end{subequations}
substituting into \erf{Eq::dsigma}, and making the usual Markov\linebreak[4] approximation \cite{le_kien_spontaneous_2005} gives an expression for the ground-excited coherences.   This yields
\begin{align}
...
\subsection{Resolution of birefringence spectroscopy measurement for the nanofiber trapped atom system (old)}\label{sec:birefringenceresolution}
