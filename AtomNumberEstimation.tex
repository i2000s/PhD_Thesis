...
\begin{minipage}{.91\linewidth}
\centering
\subfloat[]{\label{squeezingparaTerm3}\includegraphics[scale=0.55]{./Figs/squeezingparaTerm3_total}}
\end{minipage}
\par\medskip
\begin{minipage}{.91\linewidth}
\centering
\subfloat[]{\label{squeezingparaTerm4}\includegraphics[scale=0.55]{./Figs/squeezingparaTerm4_total}}
\end{minipage}
