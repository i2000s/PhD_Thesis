...
\begin{figure}[!tbp]
\centering\makebox[\textwidth]{
\includegraphics[width=12cm]{../media/Figs/nanofiber_HVmode_E_xy}}
\caption[Non-zero $ H $- and $ V $-mode components of a nanofiber in the $xy $ plane.]{Non-zero $ H $ and $ V $ mode components of a nanofiber in the $xy $ plane. The first (second) row plots the $ H $($ V $)-mode components $ \re\left[u_x(\br) \right] $, $ \re\left[u_y(\br) \right] $, and $ \im\left[u_z(\br) \right] $ from left to right. Amplitudes are normalized to the maximum value of all component parts. }\label{fig:nanofiber_HVmode_E_xy}
\end{figure}
...
\begin{figure}[!tbp]
\centering\makebox[\textwidth]{
\includegraphics[width=12cm]{../media/Figs/swg_HVmode_E_xy}}
\caption[Non-zero $ H $- and $ V $-mode components of a square waveguide in the $xy $ plane.]{Non-zero $ H $ and $ V $ mode components of a \SWG in the $xy $ plane. The first (second) row plots the $ H $($ V $)-mode components $ \re\left[u_x(\br) \right] $, $ \re\left[u_y(\br) \right] $, and $ \im\left[u_z(\br) \right] $ from left to right. Amplitudes are normalized to the maximum value of all component parts. }\label{fig:swg_HVmode_E_xy}
\end{figure}
...
\begin{figure}[!tbp]
\centering\makebox[\textwidth]{
\includegraphics[width=12cm]{../media/Figs/nanofiber_DaDmode_E_xy}}
\caption[Non-zero $ D $- and $ \bar{D} $-mode components of a nanofiber in the $xy $ plane.]{Non-zero $ D $ and $ \thickbar{D} $ mode components of a nanofiber in the $xy $ plane. The first (second) row plots the $ D $($ \thickbar{D} $)-mode components $ \re\left[u_x(\br) \right] $, $ \re\left[u_y(\br) \right] $, and $ \im\left[u_z(\br) \right] $ from left to right. Amplitudes are normalized to the maximum value of all component parts. }\label{fig:nanofiber_DaDmode_E_xy}
\end{figure}
...
Based on Eq.~\eqref{eq:eDeDbar}, the $ D $ and $ \bar{D} $ mode bases can be written as a linear combination of the $ H $ and $ V $ modes [see Fig.~\ref{fig:Modes_Rot45HV_fiber}]. We plot the non-zero component parts of the $ D $ and $ \bar{D} $ modes in Fig.~\ref{fig:nanofiber_DaDmode_E_xy}, which has a non-intuitive phase difference from the $ H $ and $ V $ mode basis [Fig.~\ref{fig:nanofiber_HVmode_E_xy}].
...
\begin{figure}[!tbp]
\centering\makebox[\textwidth]{
\includegraphics[width=12cm]{../media/Figs/swg_DaDmode_E_xy}}
\caption[Non-zero $ D $- and $ \bar{D} $-mode components of a square waveguide in the $xy $ plane.]{Non-zero $ D $ and $ \thickbar{D} $ mode components of a \SWG in the $xy $ plane. The first (second) row plots the $ D $($ \thickbar{D} $)-mode components $ \re\left[u_x(\br) \right] $, $ \re\left[u_y(\br) \right] $, and $ \im\left[u_z(\br) \right] $ from left to right. Amplitudes are normalized to the maximum value of all component parts. }\label{fig:swg_DaDmode_E_xy}
\end{figure}
