...
\GFT(\br,\br') = \left\{ 
\begin{array}{lc}
\GFT_0(\br,\br')+\GFT_R(\br,\br'), & \text{unguided-mode contributions }\\
\GFT_T(\br,\br'), & \text{guided-mode contributions}
\end{array}\right..
\end{align}
...
In the context of nanophotonic waveguides and atomic system, the dyadic Green's function can be decomposed into the free-dipole, reflective and transmissive mode contributions as defined in Eq.~\eqref{eq:GFTdecomp0RT} denoted by the subscripts, $ 0 $, $ R $ and $ T $, respectively. 
