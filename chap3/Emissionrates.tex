...
\includegraphics[width=0.75\textwidth]{../media/Figs/D2line_decaylines}}
...
Both $ \ket{f'=5,m'=4} $ to $ \ket{f=4,m=3} $ and $ \ket{f'=5,m'=4} $ to $ \ket{f=4,m=4} $ decays contribute to the spontaneous emission rate of $ \ket{f'=5,m'=4} $ sublevel. } \label{fig:D2line_decaylines}
\end{figure}
