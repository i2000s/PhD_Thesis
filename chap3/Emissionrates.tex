...
In Chapter 2, we treat the electromagnetic field classically, and neglected how the atom's decay is modified due to the presence of the nearby dielectric. 
Though the resulting estimate of dispersive response is a good approximation in many cases, the model we have used may be too rough to study other quantum effects to be discussed later, given that the polarizability of the atom was assumed to be a scalar and the modification of the atomic decay rate does not account for the detailed internal structure of the atom. 
