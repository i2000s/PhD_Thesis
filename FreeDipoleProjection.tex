...
\centering
\subfloat[$ \mathcal{C}_{r_\perp}(z) $]{\label{Crz_1}\includegraphics[scale=.42]{Figs/Cr_1}}
\end{minipage}%
\begin{minipage}{.48\linewidth}
\centering
\subfloat[$ \mathcal{C}_\phi(z) $ ]{\label{Cphiz_1}\includegraphics[scale=.42]{Figs/Cphi_1}}
\end{minipage}
\par\medskip
\begin{minipage}{.48\linewidth}
\centering
\subfloat[$ \mathcal{S}_{r_\perp}(z) $ ]{\label{Srz_1}\includegraphics[scale=.42]{Figs/Sr_1}}
\end{minipage}%
\begin{minipage}{.48\linewidth}
\centering
\subfloat[$ \mathcal{S}_\phi(z) $]{\label{Sphiz_1}\includegraphics[scale=.42]{Figs/Sphi_1}}
\end{minipage}
